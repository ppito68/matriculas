...
while($grupo=$grupos->fetch(PDO::FETCH_ASSOC)){ // (1)
    ...
    // --- LINEA DE DEPURACION-> echo "*******Grupo a generar-> Centro:" . $centroGrupo . ", Aula:" . $idAulaGrupo . ", Curso:" . $cursoGrupo . ", Horario:" . $horarioGrupo . "\n";
    ...
    // --- LINEA DE DEPURACION->echo "prefijados asistidos:" . $PrefijadosAsistidos . ", prefijados on line:" . $prefijadosOnLine . "\n";
    ...
    // --- LINEA DE DEPURACION->echo "Aforo online:" . $grupo['online'] . ", a generar online:" . $onLine . ". a generar asistentes:" . $Asisten . "\n";
    ...
    foreach($alumnosArray as &$alumno){
        ...
        // --- LINEA DE DEPURACION->echo "nºalum:" . $alumno[numero] . ", Asignado:" . $alumno["asignado"] . "\n";
    }
