...
$numero = $_GET["numero"];
$result = CovGetAlumno($numero); // En la app AssitanceControl esta funcion se llama GetAlumno(...) sin "Cov"
          ...
          <ul class="list-group">
            ...
            <li class="list-group-item">  N O T E S  
              ...
              <div class="row sm-3">
                ...
                <div class="col-sm-2">
                  <input onblur="this.value = conFormato2Dec(this.value)" onchange="calculaMedia(1)" type="number" step="0.50" class="form-control form-control-sm" id="speaking1" name="speaking1" value="' . $notas[speaking1] . '">
                </div>
                <div class="col-sm-2">
