...
$numero = $_GET["numero"];
$result = GetAlumno($numero); // En la app AssitanceControl esta funcion se llama GetAlumno(...) sin "Cov"
...
$html = '<style type="text/css">
        ...
        <form name="formNotas" action="GrabacionNotas.php" method="post">
          ...
          <ul class="list-group">
            ...
            <li class="list-group-item active">' . $alum["nombre"] . ' ' . $alum["apellidos"] . '</li>
            ...
            <li class="list-group-item">  N O T E S  
              ...
              <div class="row sm-3">
                ...
                <div class="col-sm-2">
                  <input onblur="this.value = conFormato2Dec(this.value)" onchange="calculaMedia(1)" type="number" tabindex=1 step="0.50" class="form-control form-control-sm" id="speaking1" name="speaking1" value="' . $notas[speaking1] . '">
                </div>
                <div class="col-sm-2">
                  <input onblur="this.value = conFormato2Dec(this.value)" onchange="calculaMedia(2)" type="number" tabindex=8 step="0.50" class="form-control form-control-sm" id="speaking2" name="speaking2" value="' . $notas[speaking2] . '">
                </div>
              </div>
              ...
              <div class="row sm-3">
                ...
                <div class="col-sm-2">
                  <input onblur="this.value = conFormato2Dec(this.value)" onchange="calculaMedia(1)" type="number" tabindex=2 step="0.50" class="form-control form-control-sm" id="listening1" name="listening1" value="' . $notas[listening1] . '">
                </div>
                <div class="col-sm-2">
                  <input onblur="this.value = conFormato2Dec(this.value)" onchange="calculaMedia(2)" type="number" tabindex=9 step="0.50" class="form-control form-control-sm" id="listening2" name="listening2" value="' . $notas[listening2] . '">
                </div>                
              </div>
              ...
              <div class="row sm-3">
                ...
                <div class="col-sm-2">
                  <input onblur="this.value = conFormato2Dec(this.value)" onchange="calculaMedia(1)" type="number" tabindex=3 step="0.50" class="form-control form-control-sm" id="writing1" name="writing1" value="' . $notas[writing1] . '">
                </div>
                <div class="col-sm-2">
                  <input onblur="this.value = conFormato2Dec(this.value)" onchange="calculaMedia(2)" type="number" tabindex=10 step="0.50" class="form-control form-control-sm" id="writing2" name="writing2" value="' . $notas[writing2] . '">
                </div>                                
              </div>
              ...
              <div class="row sm-3">
                ...
                <div class="col-sm-2">
                  <input onblur="this.value = conFormato2Dec(this.value)" onchange="calculaMedia(1)" type="number"  tabindex=4 step="0.50" class="form-control form-control-sm" id="reading1" name="reading1" value="' . $notas[reading1] . '">
                </div>
                <div class="col-sm-2">
                  <input onblur="this.value = conFormato2Dec(this.value)" onchange="calculaMedia(2)" type="number" tabindex=11 step="0.50" class="form-control form-control-sm" id="reading2"  name="reading2" value="' . $notas[reading2] . '">
                </div>                                
              </div>
              ...
              <div class="row sm-3">
                ...
                <div class="col-sm-2">
                  <input onblur="this.value = conFormato2Dec(this.value)" onchange="calculaMedia(1)" type="number" tabindex=5 step="0.50" class="form-control form-control-sm" id="examenEscrito1" name="examenEscrito1" value="' . $notas[examenEscrito1] . '">
                </div>
                <div class="col-sm-2">
                  <input onblur="this.value = conFormato2Dec(this.value)" onchange="calculaMedia(2)" type="number" tabindex=12 step="0.50" class="form-control form-control-sm" id="examenEscrito2" name="examenEscrito2" value="' . $notas[examenEscrito2] . '">
                </div>                                
              </div>
            ...
            <li class="list-group-item">BRIEFING NOTES
              ...
              <div class="row sm-3">
                ...
                <div class="col-sm-2">
                  <input onblur="this.value = conFormato2Dec(this.value)" type="number" tabindex=6 step="0.50" class="form-control form-control-sm" id="participacion1" name="participacion1" value="' . $notas[participacion1] . '">
                </div>
                <div class="col-sm-2">
                  <input onblur="this.value = conFormato2Dec(this.value)" type="number" tabindex=13 step="0.50" class="form-control form-control-sm" id="participacion2" name="participacion2" value="' . $notas[participacion2] . '">
                </div>                                
              </div>
              ...
              <div class="row sm-3">
                ...
                <div class="col-sm-2">
                  <input onblur="this.value = conFormato2Dec(this.value)" type="number" tabindex=7 step="0.50" class="form-control form-control-sm" id="comportamiento1" name="comportamiento1" value="' . $notas[comportamiento1] . '">
                </div>
                <div class="col-sm-2">
                  <input onblur="this.value = conFormato2Dec(this.value)" type="number" step="0.50" class="form-control form-control-sm" id="comportamiento2" name="comportamiento2" value="' . $notas[comportamiento2] . '">
                </div>                                
              </div>
              ...
              <div class="row sm-3">
                ...
                <div class="col-sm-2">
                  <input onblur="this.value = conFormato2Dec(this.value)" type="number" step="0.50" class="form-control form-control-sm" id="examenOral" name="examenOral" value="' . $notas[examenOral2] . '">
                </div>                                
              </div>
          ...
          <div>
            ...
            <button type="button" class="btn btn-secondary" onclick="PanelAsistencias()">BACK TO LIST</button>
            <button type="button" class="btn btn-secondary" onclick="VerNotasEnPdf()">View Pdf</button>
            <button type="button" class="btn btn-secondary" onclick="">Send notes by email</button>
          </div>
